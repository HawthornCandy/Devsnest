...
Cover image for Building a Simple Quiz with HTML, CSS and JavaScript
Building a Simple Quiz with HTML, CSS and JavaScript
#css #html #javascript #quiz
...
Sulaimon Olaniran
A self learning Front_End Developer aspiring to become a Full-Stack developer with time.
Follow 
WORK
Front-End Developer
LOCATION
Lagos, Nigeria.
EDUCATION
B.Tech. in Transport Management, Ladoke Akintola University of Technology, Ogbomosho, Nigeria.
JOINED
১৬ জুলাই, ২০২০
More from Sulaimon Olaniran
Creating A NavBar drawer with HTML/CSS.
#html #css #javascript
Top 5 Mistakes I Made So Far In My Programming Journey
